...
class clic_classModel{
	...
	public function getClassList($condition){
		...
		$param = array();
		$param['table'] = 'clic_class';
		$param['appointment'] = $condition['appointment'] ? $condition['appointment'] : 'sc_parent_id asc,sc_sort asc,sc_id asc';
	...
	public function add($param){
		...
		if (is_array($param)){
			...
			$result = Db::insert('clic_class',$tmp);
			return $result;
		}else {
			return false;
		}
	...
	public function update($param){
		...
		if (is_array($param)){
			...
			$result = Db::update('clic_class',$tmp,$where);
			return $result;
		}else {
			return false;
		}
	...
	public function del($id){
		if (intval($id) > 0){
			...
			$result = Db::delete('clic_class',$where);
			return $result;
		}else {
			return false;
		}
	...
	public function getTreeList(){
		$show_class = array();
		$class_list = $this->getClassList(array('appointment'=>'sc_parent_id asc,sc_sort asc,sc_id asc'));
	...
	public function getChildClass($parent_id){
		$all_class = $this->getClassList(array('appointment'=>'sc_parent_id asc,sc_sort asc,sc_id asc'));
