...
class doctors_class_stapleModel extends Model {
    public function __construct(){
        parent::__construct('doctors_class_staple');
    }
     ...
     * @return array 二维数组
     */
    public function getStapleList($condition, $field = '*', $appointment = 'counter desc', $limit = 20) {
        $result = $this->field($field)->where($condition)->appointment($appointment)->limit($limit)->select();
        return $result;
    }
