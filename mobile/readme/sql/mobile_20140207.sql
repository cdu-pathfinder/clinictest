INSERT INTO `clinicnc_setting` (`name`, `value`) VALUES ('mobile_isuse', '1');

DROP TABLE IF EXISTS `clinicnc_mb_ad`;
CREATE TABLE `clinicnc_mb_ad` (
...
INSERT INTO `clinicnc_mb_ad` VALUES (15,'户外旅行','a93071f217d821d262a6ad081d383838.jpg',255,NULL),(16,'电器专场','8b89103d674133e00aadb2a0aa350e48.jpg',111,NULL),(13,'日用百货','adbbb2e550645d098d3e4ab92226de2a.jpg',128,'百货'),(14,'服饰专场','bd4fba92244e62aea5629aeeab2d9d95.jpg',255,NULL);

DROP TABLE IF EXISTS `clinicnc_mb_feedback`;
CREATE TABLE `clinicnc_mb_feedback` (
...
DROP TABLE IF EXISTS `clinicnc_mb_home`;
CREATE TABLE `clinicnc_mb_home` (
