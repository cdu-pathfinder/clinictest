  ...
  <form id="grade_form" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="nobappointment">
          <td class="vatop rowform"><input type="text" value="0" id="sg_doctors_limit" name="sg_doctors_limit" class="txt"></td>
        ...
        <tr class="nobappointment">
          <td class="vatop rowform"><span class="grey">(<?php echo $lang['in_clic_grade_list_set'];?>)</span></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
