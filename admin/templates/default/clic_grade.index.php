...
<div class="page">
  ...
  <form method="post" name="formSearch">
    <table class="tb-type1 nobappointment search">
      <tbody>
        <tr>
          <th><label for="like_sg_name"><?php echo $lang['clic_grade_name'];?></label></th>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query']; ?>">&nbsp;</a>
            ...
            <a class="btns " href="index.php?act=clic_grade&op=clic_grade" title="<?php echo $lang['cancel_search'];?>"><span><?php echo $lang['cancel_search'];?></span></a>
            <?php }?></td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          ...
          <th><?php echo $lang['clic_grade_name'];?></th>
          <th class="align-center"><?php echo $lang['allow_pubilsh_doc_num'];?></th>
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="align-center"><?php echo $v['sg_doctors_limit'];?></td>
          ...
          <td class="w270"><a href="index.php?act=clic_grade&op=clic_grade_edit&sg_id=<?php echo $v['sg_id'];?>"><?php echo $lang['nc_edit'];?></a> |
            <?php if($v['sg_id'] == '1'){ ?>
            <?php echo $lang['default_clic_grade_no_del'];?> |
            <?php }else { ?>
            <a href="javascript:if(confirm('<?php echo $lang['problem_del'];?>'))window.location = 'index.php?act=clic_grade&op=clic_grade_del&sg_id=<?php echo $v['sg_id'];?>';"><?php echo $lang['nc_del'];?></a> |
            <?php } ?>
            <a href="index.php?act=clic_grade&op=clic_grade_templates&sg_id=<?php echo $v['sg_id'];?>"><?php echo $lang['set_template'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
