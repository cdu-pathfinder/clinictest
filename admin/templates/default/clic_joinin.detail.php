  ...
  <table bappointment="0" cellpadding="0" cellspacing="0" class="clic-joinin">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td colspan="20"><a nctype="nyroModal"  href="<?php echo getclicJoininImageUrl($output['joinin_detail']['organization_code_electronic']);?>"> <img src="<?php echo getclicJoininImageUrl($output['joinin_detail']['organization_code_electronic']);?>" alt="" /> </a></td>
      </tr>
    </tbody>
  </table>
  <table bappointment="0" cellpadding="0" cellspacing="0" class="clic-joinin">
    ...
    <tbody>
      <tr>
        ...
        <td colspan="20"><a nctype="nyroModal"  href="<?php echo getclicJoininImageUrl($output['joinin_detail']['general_taxpayer']);?>"> <img src="<?php echo getclicJoininImageUrl($output['joinin_detail']['general_taxpayer']);?>" alt="" /> </a></td>
      </tr>
    </tbody>
  </table>
  <table bappointment="0" cellpadding="0" cellspacing="0" class="clic-joinin">
...
Electronic version:</th>
  ...
  <form id="form_clic_verify" action="index.php?act=clic&op=clic_joinin_verify" method="post">
    ...
    <table bappointment="0" cellpadding="0" cellspacing="0" class="clic-joinin">
      ...
      <tbody>
        <tr>
          ...
          <td><?php echo $output['joinin_detail']['clinicer_name'];?></td>
        </tr>
        <tr>
          ...
          <td colspan="2"><table bappointment="0" cellpadding="0" cellspacing="0" id="table_category" class="type">
              ...
              <tbody>
                ...
                <?php if(intval($output['joinin_detail']['joinin_state']) === 10) {?>
                  <input type="text" nctype="commis_rate" value="<?php echo $clic_class_commis_rates[$i];?>" name="commis_rate[]" class="w100" />%
                <?php }else { ?>
                <?php echo $clic_class_commis_rates[$i];?>
                <?php } ?>
                </td>
                </tr>
                <?php } ?>
    ...
    <?php if(in_array(intval($output['joinin_detail']['joinin_state']), array(clic_JOIN_STATE_PAY, clic_JOIN_STATE_FINAL))) {?>
    <tr>
        <th>Payment voucher:</th>
        <td><a nctype="nyroModal"  href="<?php echo getclicJoininImageUrl($output['joinin_detail']['paying_money_certificate']);?>"> <img src="<?php echo getclicJoininImageUrl($output['joinin_detail']['paying_money_certificate']);?>" alt="" /> </a></td>
    </tr>
    <tr>
    ...
    <?php } ?>
   <?php if(in_array(intval($output['joinin_detail']['joinin_state']), array(clic_JOIN_STATE_NEW, clic_JOIN_STATE_PAY))) { ?>
    <tr>
