...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?act=evaluate&op=evaldoctors_list" ><span><?php echo $lang['admin_evaluate_list'];?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['admin_evalclic_list'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method="get" name="formSearch">
    ...
    <input type="hidden" name="op" value="evalclic_list" />
  ...
  <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td><ul>
            <li><?php echo $lang['admin_evalclic_help1'];?></li>
            <li><?php echo $lang['admin_evalclic_help2'];?></li>
          </ul></td>
      </tr>
    </tbody>
  </table>
  <table class="table tb-type2 evallist">
    <thead>
      <tr class="thead">
        <th><?php echo $lang['admin_evaluate_clicname'];?></th>
        <th class="w150 align-center"><?php echo $lang['admin_evaluate_appointmentsn'];?></th>
        <th class="w150 align-center"><?php echo $lang['admin_evaluate_frommembername'];?></th>
        <th class="w150 align-center"><?php echo $lang['admin_evalclic_score'];?></th>
        <th class="w150 align-center"><?php echo $lang['admin_evaluate_addtime'];?></th>
        <th class="w72 align-center"><?php echo $lang['nc_handle'];?></th>
      </tr>
    </thead>
    <tbody>
        <?php if(!empty($output['evalclic_list']) && is_array($output['evalclic_list'])){?>
      <?php foreach($output['evalclic_list'] as $v){?>
      <tr class="hover">
      	<td><?php echo $v['seval_clicname'];?></td>
      	<td class="align-center"><?php echo $v['seval_appointmentno'];?></td>
...
<form id="submit_form" action="<?php echo urlAdmin('evaluate', 'evalclic_del');?>" method="post">
