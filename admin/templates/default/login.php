...
<div class="login-layout">
  ...
  <div class="box">
    <form method="post" id="form_login">
      ...
      <input type="hidden" name="SiteUrl" id="SiteUrl" value="<?php echo clinic_SITE_URL;?>" />
      <span>
...
title="<?php echo $lang['login_index_password_pattern'];?>">
      ...
      <div class="code">
        <div class="arrow"></div>
        <div class="code-img"><img src="index.php?act=seccode&op=makecode&admin=1&nchash=<?php echo getNchash();?>" name="codeimage" id="codeimage" bappointment="0"/></div>
...
<div class="bottom">
  ...
  <h6 title="<?php echo $lang['login_index_clinicnc'];?>">© 2020 <a href="http://www.clinicnc.net/" target="_blank">liam.</a></h6>
</div>
