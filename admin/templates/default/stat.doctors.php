...
<div class="page">
  ...
  <div class="stat-info"><span>上架商品数：<strong><?php echo intval($output['doctors_on_allnum']); ?></strong></span><span>下单商品数：<strong><?php echo intval($output['appointment_doctors_num']); ?></strong></span><span>下单单数：<strong><?php echo intval($output['appointment_num']); ?></strong></span><span>下单客户数：<strong><?php echo intval($output['appointment_buyer_num']); ?></strong></span><span>合计金额：<strong><?php echo number_format($output['appointment_amount'],2); ?></strong>元</span></div>
