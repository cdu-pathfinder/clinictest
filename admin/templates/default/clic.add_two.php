  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=clic&op=clic_auth" ><span><?php echo $lang['clic_auth_verify'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form id="clic_form" method="post">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label for="clic_owner_card"><?php echo $lang['clic_user_id'];?>:</label></td>
        </tr>
        <tr class="nobappointment">
          <td class="vatop rowform"><input type="text" value="" id="clic_owner_card" name="clic_owner_card" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="nobappointment">
          <td class="vatop rowform"><input type="text" value="" id="clic_name" name="clic_name" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="2" class="required"><label for="clic_address"><?php echo $lang['details_address'];?>:</label></td>
        </tr>
        <tr class="nobappointment">
          <td class="vatop rowform"><input type="text" value="" id="clic_address" name="clic_address" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><label for="clic_zip"><?php echo $lang['zip'];?>:</label></td>
        </tr>
        <tr class="nobappointment">
          <td class="vatop rowform"><input type="text" value="" id="clic_zip" name="clic_zip" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><label for="clic_tel"><?php echo $lang['tel_phone'];?>:</label></td>
        </tr>
        <tr class="nobappointment">
          <td class="vatop rowform"><input type="text" value="" id="clic_tel" name="clic_tel" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="nobappointment">
          <td class="vatop rowform onoff"><label for="clic_state1" class="cb-enable selected"><span><?php echo $lang['open'];?></span></label>
            <label for="clic_state0" class="cb-disable" ><span><?php echo $lang['close'];?></span></label>
            <input id="clic_state1" name="clic_state" checked="" onclick="$('#tr_clic_close_info').hide();" value="1" type="radio">
            <input id="clic_state0" name="clic_state" onclick="$('#tr_clic_close_info').show();" value="0" type="radio"></td>
        </tr>
      </tbody>
      <tbody id="tr_clic_close_info">
        ...
        <tr class="nobappointment">
          <td class="vatop rowform"><label for="clic_close_info"></label>
            <textarea rows="6" class="tarea" id="clic_close_info" name="clic_close_info"></textarea></td>
          <td class="vatop tips"></td>
        </tr>
      </tbody>
      <tbody>
        ...
        <tr class="nobappointment">
          <td class="vatop rowform"><ul class="nofloat">
              ...
              <li>
                <label for="material">
                  <input type="checkbox" id="clic_auth" value="1" name="clic_auth">
                  <?php echo $lang['entity_clic_certification'];?></label>
              </li>
            </ul></td>
          <td class="vatop tips"></td>
        </tr>
        ...
        <tr class="nobappointment">
          <td class="vatop rowform onoff"><label for="clic_recommend1" class="cb-enable selected" ><span><?php echo $lang['nc_yes'];?></span></label>
            <label for="clic_recommend0" class="cb-disable" ><span><?php echo $lang['nc_no'];?></span></label>
            <input id="clic_recommend1" name="clic_recommend" checked="" value="1" type="radio">
            <input id="clic_recommend0" name="clic_recommend" value="0" type="radio"></td>
        ...
        <tr class="nobappointment">
          <td class="vatop rowform"><input type="text" value="0" id="clic_sort" name="clic_sort" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
      </tbody>
      <tfoot>
