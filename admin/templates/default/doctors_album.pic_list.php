...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?act=doctors_album&op=list"><span><?php echo $lang['g_album_list'];?></span></a></li>
          ...
          <li class="picture">
            <div class="size-64x64">
              <span class="thumb">
                <i></i>
				<?php if($v['apic_cover'] != ''){ ?>
				<a nctype="nyroModal"  href="<?php echo cthumb($v['apic_cover'], 1280, $v['clic_id']);?>" rel="gal"><img title="<?php echo date('Y-m-d',$v['upload_time']);?><br/><?php echo $v['apic_spec'];?>px<br/><?php echo number_format($v['apic_size']/1024,2);?>k" width="64" height="64"  class="tip" src="<?php echo cthumb($v['apic_cover'], 60, $v['clic_id']);?>"></a>
				<?php }else{?>
...
$(function(){
	...
	$('a[nc_type="delete"]').bind('click',function(){
		...
		cur_note = this;
		$.get("index.php?act=doctors_album&op=del_album_pic", {'key':$(this).attr('nc_key')}, function(data){
            if (data == 1)
