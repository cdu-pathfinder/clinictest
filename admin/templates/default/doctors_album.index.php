  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=doctors_album&op=pic_list" ><span><?php echo $lang['g_album_pic_list'];?></span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form method="get" name="formSearch">
    <input type="hidden" name="act" value="doctors_album">
      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            <?php if($output['clic_name'] != '' && !empty($output['list']) ){?>
            <a class="btns" target="_blank" href="<?php echo urlclinic('show_clic','index', array('clic_id'=>$output['list'][0]['clic_id']));?>"><span><?php echo $output['clic_name'];?></span></a>
            <?php }?>
            </td>
        </tr>
      </tbody>
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          ...
          <th class=" w270"><?php echo $lang['g_album_clinic'];?></th>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <?php if($v['aclass_cover'] != ''){ ?>
              <img src="<?php echo cthumb($v['aclass_cover'], 60, $v['clic_id']);?>" onload="javascript:DrawImage(this,70,70);">
              <?php }else{?>
          ...
          <td class="class"><a href="<?php echo urlclinic('show_clic','index', array('clic_id'=>$v['clic_id']));?>" target="_blank"><?php echo $v['clic_name'];?></td>
          <td><?php echo $output['pic_count'][$v['aclass_id']]?$output['pic_count'][$v['aclass_id']]:0;?></td>
          <td class="align-center"><a href="index.php?act=doctors_album&op=pic_list&aclass_id=<?php echo $v['aclass_id'];?>"><?php echo $lang['d'];?><?php echo $lang['g_album_pic_one'];?></a>&nbsp;|&nbsp;<a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?act=doctors_album&op=aclass_del&aclass_id=<?php echo $v['aclass_id'];?>';}else{return false;}"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
