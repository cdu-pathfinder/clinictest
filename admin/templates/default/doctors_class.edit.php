...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?act=doctors_class&op=doctors_class"><span><?php echo $lang['nc_manage'];?></span></a></li>
        <li><a href="index.php?act=doctors_class&op=doctors_class_add"><span><?php echo $lang['nc_new'];?></span></a></li>
  ...
  <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td>
        <ul>
            <li><?php echo $lang['doctors_class_edit_prompts_one'];?></li>
            <li><?php echo $lang['doctors_class_edit_prompts_two'];?></li>
            <li><?php echo $lang['doctors_class_edit_prompts_three'];?></li>
          </ul></td>
      </tr>
    </tbody>
  </table>
  <form id="doctors_class_form" name="doctorsClassForm" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        <tr class="nobappointment">
          <td colspan="2" class="required"><label class="gc_name validation" for="gc_name"><?php echo $lang['doctors_class_index_name'];?>:</label></td>
        </tr>
        <tr class="nobappointment">
        ...
        <tr>
          <td colspan="2" class="required" id="gcategory">
            <label for="gc_name"><?php echo $lang['doctors_class_add_type'];?>:</label>
        ...
        <tr class="nobappointment">
          ...
          <div style="position:relative; max-height:240px; overflow: hidden;" id="type_div"><div>
              ...
              <span><?php echo $lang['doctors_class_null_type'];?></span>
          	</dd>
          	</dl>
          ...
          <div class=" mtm"><input type="checkbox" name="t_associated" value="1" checked="checked" id="t_associated" /><label for="t_associated"><?php echo $lang['doctors_class_edit_related_to_subclass'];?></label></div>
          </td>
          <td class="vatop tips"><?php echo $lang['doctors_class_add_type_desc_one'];?><a onclick="window.parent.openItem('type,type,doctors')" href="JavaScript:void(0);"><?php echo $lang['nc_type_manage'];?></a><?php echo $lang['doctors_class_add_type_desc_two'];?></td>
        </tr>
        <tr>
        ...
        <tr class="nobappointment">
          ...
          <td class="vatop tips"><?php echo $lang['doctors_class_add_update_sort'];?></td>
        </tr>
      </tbody>
      <tfoot>
	...
	$('#doctors_class_form').validate({
        ...
        rules : {
            gc_name : {
                required : true,
                remote   : {                
                url :'index.php?act=doctors_class&op=ajax&branch=check_class_name',
                type:'get',
                data:{
                    gc_name : function(){
                        return $('#gc_name').val();
        ...
        messages : {
             gc_name : {
                required : '<?php echo $lang['doctors_class_add_name_null'];?>',
                remote   : '<?php echo $lang['doctors_class_add_name_exists'];?>'
            },
            gc_sort  : {
                number   : '<?php echo $lang['doctors_class_add_sort_int'];?>'
            }
        }
    });
