    ...
    <table class="tb-type1 nobappointment search">
      <tbody>
        ...
        <th><label for="add_time_from">订单类型</label></th>
          ...
          <a class="btns" href="index.php?<?php echo $_SERVER['QUERY_STRING'];?>&op=export_refund_appointment"><span><?php echo $lang['nc_exposrt'];?>导出退单明细</span></a>
            </td>
        </tr>
      </tbody>
    </table>
...
<table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="align-center"><?php echo $refund_info['appointment_sn'];?></td>
