...
<div class="fixed-empty"></div>  
    <table class="table tb-type2 nobappointment search">
      <tbody>
      <tr><td>店铺 - <?php echo $output['bill_info']['ob_clic_name'];?>（ID：<?php echo $output['bill_info']['ob_clic_id'];?>） <?php echo $output['bill_info']['os_month'];?> 期 结算单&emsp;
      <?php if ($output['bill_info']['ob_state'] == BILL_STATE_clic_COFIRM){?>
      ...
      <?php }?>
        ...
        <tr><td><?php echo $lang['appointment_time_from'];?>结算单号<?php echo $lang['nc_colon'];?><?php echo $output['bill_info']['ob_no'];?></td></tr>
      ...
      <td>平台应付金额：<?php echo $output['bill_info']['ob_result_totals'];?> = <?php echo $output['bill_info']['ob_appointment_totals'];?> (订单金额) - <?php echo $output['bill_info']['ob_commis_totals'];?> (佣金金额) - <?php echo $output['bill_info']['ob_appointment_return_totals'];?> (退单金额) + <?php echo $output['bill_info']['ob_commis_return_totals'];?> (退还佣金) - <?php echo $output['bill_info']['ob_clic_cost_totals'];?> (店铺促销费用)</td>
      </tr>
