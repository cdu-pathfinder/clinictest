      ...
      <tbody>
        ...
        <tr class="nobappointment">
          <td class="vatop rowform"><ul class="nofloat">
              ...
              <li>
                <input type="checkbox" value="1" name="captcha_status_doctorsqa" id="captcha_status3" <?php if($output['list_setting']['captcha_status_doctorsqa'] == '1'){ ?>checked="checked"<?php } ?> />
                <label for="captcha_status3"><?php echo $lang['front_doctorsqa'];?></label>
              </li>
            </ul></td>
