...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3><?php echo $lang['clic_grade'];?></h3>
      <ul class="tab-base">
        <li><a href="index.php?act=clic_grade&op=clic_grade" ><span><?php echo $lang['manage'];?></span></a></li>
        <li><a href="index.php?act=clic_grade&op=clic_grade_add" ><span><?php echo $lang['nc_new'];?></span></a></li>
  ...
  <form id="grade_form" method="post">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        <tr>
          <td colspan="2" class="required"><label class="validation" for="sg_name"><?php echo $lang['clic_grade_name'];?>:</label></td>
        </tr>
        ...
        <tr>
          <td colspan="2" class="required"><label for="sg_doctors_limit"><?php echo $lang['allow_pubilsh_doc_num'];?>:</label></td>
        </tr>
        <tr class="nobappointment">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['grade_array']['sg_doctors_limit'];?>" id="sg_doctors_limit" name="sg_doctors_limit" class="txt"></td>
        ...
        <tr class="nobappointment">
          <td class="vatop rowform"><?php echo $output['grade_array']['sg_template_number'];?> <span class="grey">(<?php echo $lang['in_clic_grade_list_set'];?>)</span></td>
	...
	$('#grade_form').validate({
        ...
        rules : {
            sg_name : {
                required : true,
                remote   : {
                url :'index.php?act=clic_grade&op=ajax&branch=check_grade_name',
                type:'get',
                data:{
                        sg_name : function(){
                        	return $('#sg_name').val();
            ...
            sg_sort : {
                ...
                digits  : true,
                remote   : {
	                url :'index.php?act=clic_grade&op=ajax&branch=check_grade_sort',
	                type:'get',
	                data:{
	                        sg_sort : function(){
	                        	return $('#sg_sort').val();
        ...
        messages : {
            sg_name : {
                required : '<?php echo $lang['clic_grade_name_no_null'];?>',
                remote   : '<?php echo $lang['now_clic_grade_name_is_there'];?>'
            },
			sg_price : {
