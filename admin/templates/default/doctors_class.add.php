...
<div class="page">
  ...
  <form id="doctors_class_form" enctype="multipart/form-data" method="post">
    <input type="hidden" name="form_submit" value="ok" />
    <table class="table tb-type2">
      <tbody>
        <tr class="nobappointment">
          <td colspan="2" class="required"><label class="validation" for="gc_name"><?php echo $lang['doctors_class_index_name'];?>:</label></td>
        </tr>
        <tr class="nobappointment">
        ...
        <tr>
          <td colspan="2" class="required"><label for="parent_id"><?php echo $lang['doctors_class_add_sup_class'];?>:</label></td>
        </tr>
        <tr class="nobappointment">
          ...
          <td class="vatop tips"><?php echo $lang['doctors_class_add_sup_class_notice'];?></td>
        </tr>
        <tr>
