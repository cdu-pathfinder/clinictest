    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="line">
          ...
          <td><a href="JavaScript:void(0);" class="show_detail"><?php echo $lang['nc_detail'];?></a> <a href="index.php?act=inform&op=show_handle_page&inform_id=<?php echo $v['inform_id'];?>&inform_doctors_name=<?php echo $v['inform_doctors_name'];?>"><?php echo $lang['inform_text_handle'];?></a></td>
        </tr>
