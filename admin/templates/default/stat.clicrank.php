...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="act" value="stat_clic" />
  ...
  <div class="stat-info"><?php if(trim($output['data_null']) != 'yes' && trim($_GET['clic_name'])!=''){ ?><span>店铺：<strong><?php echo trim($_GET['clic_name']); ?></strong></span><?php } ?><span>总下单量：<strong><?php echo $output['sum_data'][0]; ?></strong></span><span>总销售额：<strong><?php echo $output['sum_data'][1]?$output['sum_data'][1]:'0.00'; ?></strong>元</span></div>
  <div id="container" class="w100pre close_float" style="height:400px"></div>
  <div style="text-align:right;">
  	<input type="hidden" id="export_type" name="export_type" data-param='{"url":"<?php echo $output['actionurl'];?>&stat_type=<?php echo trim($_GET['stat_type']); ?>&appointment_type=<?php echo trim($_GET['appointment_type']); ?>&clic_name=<?php echo trim($_GET['clic_name']); ?>&exporttype=excel"}' value="excel"/>
