...
<div class="ncs-info">
  ...
  <div class="content">
    ...
    <div class="goto"><a href="<?php echo urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']), $output['store_info']['store_domain']);?>" target="_blank">enter the clinic</a></div>
  </div>
</div>
<script>
$(function(){
