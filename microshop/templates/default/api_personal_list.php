...
<ul id="indexPersonal" class="jcarousel-skin-personal">
    ...
    <li>
    <div class="cms-thumb"><a href="<?php echo MICROclinic_SITE_URL;?>/index.php?act=personal&op=detail&personal_id=<?php echo $value['personal_id'];?>">
    ...
    <dl>
        ...
        <dd class="member-id"><a href="<?php echo MICROclinic_SITE_URL;?>/index.php?act=home&member_id=<?php echo $value['commend_member_id'];?>"> <?php echo $value['member_name'];?></a></dd>
        ...
        <dd class="like"><i></i><?php echo $lang['nc_microclinic_like'];?><em><?php echo $value['like_count'];?></em></dd>
    </dl>
    </li>
    <?php } ?>
    <?php } ?>
