...
function selClass($this){
    ...
    $.getJSON('index.php?act=clic_doctors_add&op=ajax_doctors_class', {gc_id : data_str.gcid, deep: deep}, function(data) {
        if (data != null) {
...
$(function(){
    ...
    $('#commListArea').find('span[nctype="staple_name"]').die().live('click',function() {
        ...
        $.getJSON('index.php?act=clic_doctors_add&op=ajax_show_comm&stapleid=' + data_str.stapleid, function(data) {
            if (data.done) {
    ...
    $('#commListArea').find('a[nctype="del-comm-cate"]').die().live('click',function() {
        $this = $(this);
        eval('var data_str = ' + $this.parents('li').attr('data-param'));
        $.getJSON('index.php?act=clic_doctors_add&op=ajax_stapledel&staple_id='+ data_str.stapleid, function(data) {
            if (data.done) {
