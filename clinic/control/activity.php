...
class activityControl extends BaseHomeControl {
	...
	public function indexOp(){
		...
		//查询活动内容信息
		$list	= array();
		$list	= Model('activity_detail')->getdoctorsList(array('appointment'=>'activity_detail.activity_detail_sort asc','activity_id'=>"$activity_id",'doctors_show'=>'1','activity_detail_state'=>'1'));
