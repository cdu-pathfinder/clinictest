...
class sconnectControl extends BaseHomeControl{
	...
	public function registerOp(){
		...
		if($result) {
			...
			showMessage(Language::get('login_usersave_regist_fail'),clinic_SITE_URL.'/index.php?act=login&op=register','html','error');
		}
	}
	/**
	 * 新浪微博账号绑定已有用户
	...
	public function changesinaOp(){
		...
		header('Location:'.clinic_SITE_URL.'/api.php?act=tosina');
		exit;
	}
}