...
<div id="faq">
  <div class="wrapper">
   ...
   <li> <dl class="s<?php echo ''.$k+1;?>">
      ...
      <dd><i></i><a href="<?php if($article['article_url'] != '')echo $article['article_url'];else echo urlclinic('article', 'show',array('article_id'=> $article['article_id']));?>" title="<?php echo $article['article_title']; ?>"> <?php echo $article['article_title'];?> </a></dd>
      <?php }?>
      <?php }?>
    </dl></li>
    <?php }?>
...
<div id="footer" class="wrapper">
  <p><a href="<?php echo clinic_SITE_URL;?>"><?php echo $lang['nc_index'];?></a>
...
<center><div style=line-height:21px>
Copyright&copy;2017 - 2022 <a href="http://www.beian.miit.gov.cn/" target="_blank" style="color: 000;">students of CDU</a>
</div></center>
...
$(function(){
	// Membership card
	$('[nctype="mcard"]').membershipCard({type:'clinic'});
});
</script>
