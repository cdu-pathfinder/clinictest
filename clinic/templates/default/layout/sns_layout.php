...
<link href="<?php echo clinic_TEMPLATES_URL;?>/css/sns.css" rel="stylesheet" type="text/css">
<link id="skin_link" href="<?php echo clinic_TEMPLATES_URL;?>/sns/style/<?php echo $output['skin_style'];?>.css" rel="stylesheet" type="text/css">
...
var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo clinic_SITE_URL;?>';var clinic_SITE_URL = '<?php echo clinic_SITE_URL;?>';var MAX_RECORDNUM = <?php echo $output['max_recordnum'];?>;var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var clinic_RESOURCE_SITE_URL = '<?php echo clinic_RESOURCE_SITE_URL;?>';var clinic_TEMPLATES_URL = '<?php echo clinic_TEMPLATES_URL;?>';
</script>
  ...
  <div class="wrapper">
    ...
    <div class="search">
      <form id="formSearch" name="formSearch" action="index.php" method="get">
        ...
        <a class="ncs-search-btn-mall" nctype="search_in_clinic" href="javascript:void(0)" onClick="$('#formSearch').submit();"> <span><?php echo $lang['nc_common_search'];?></span> </a>
      </form>
    </div>
    <?php if($output['relation'] != 0){?>
    <ul class="menu">
      <li class="nobappointment"><a href="index.php?act=member_snsindex"><?php echo $lang['sns_return_my_clinic'];?></a></li>
...
<div id="container" class="wrapper mt20">
  ...
  <div class="sns-nav">
    <ul>
      ...
      <li><a <?php if($output['menu_sign'] == 'sharedoctors'){?>class="current"<?php }?> href="index.php?act=member_snshome&op=shareglist<?php if(!empty($output['master_id'])){ echo '&mid='.$output['master_id']; }?>"><i class="doctors pngFix"></i><?php echo $lang['sns_treasure'];?></a></li>
      <li><a <?php if($output['menu_sign'] == 'shareclic'){?>class="current"<?php }?> href="index.php?act=member_snshome&op=cliclist<?php if(!empty($output['master_id'])){ echo '&mid='.$output['master_id']; }?>"><i class="clic pngFix"></i><?php echo $lang['sns_clic'];?></a></li>
