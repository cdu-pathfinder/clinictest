...
<link href="<?php echo clinic_TEMPLATES_URL;?>/css/member.css" rel="stylesheet" type="text/css">
...
<header id="header" class="pngFix">
  <div class="wrapper">
    <h1 id="logo" title="<?php echo C('site_name'); ?>"><a href="<?php echo clinic_SITE_URL;?>"><img src="<?php echo C('member_logo') == ''?UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.C('site_logo'):UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.C('member_logo'); ?>" alt="<?php echo C('site_name'); ?>" class="pngFix"></a></h1>
    <nav>
      <ul>
...
<div id="container" class="wrapper">
  <div class="layout">
    <?php if($output['left_show'] != 'appointment_view') { ?>
    <div class="sidebar">
      <dl class="ncu-user">
      ...
      <div class="business-intro">
        ...
        <ul>
          <li><span><a href="index.php?act=member_appointment&state_type=state_new"><?php echo $lang['nc_appointment_waitpay'];?></a></span> <i <?php if($output['member_info']['appointment_nopay'] > 0){ echo "class='yes'";}else{ echo "class='no'";}?>><?php echo $output['member_info']['appointment_nopay'];?></i></li>
          <li><span><a href="index.php?act=member_appointment&state_type=state_send"><?php echo $lang['nc_appointment_receiving'];?></a></span> <i <?php if($output['member_info']['appointment_noreceiving'] > 0){ echo "class='yes'";}else{ echo "class='no'";}?>><?php echo $output['member_info']['appointment_noreceiving'];?></i></li>
          <li><span><a href="index.php?act=member_appointment&state_type=state_noeval"><?php echo $lang['nc_appointment_waitevaluate'];?></a></span> <i <?php if($output['member_info']['appointment_noeval'] > 0){ echo "class='yes'";}else{ echo "class='no'";}?>><?php echo $output['member_info']['appointment_noeval'];?></i></li>
        </ul>
      </div>
      <script type="text/javascript">
	// <![CDATA[
	...
	// ]]>
      ...
      <div class="business-handle" id="my_menu">
        <h3><?php echo $lang['nc_member_appointment_manage'];?></h3>
        <div class="normal"><em class="i1"></em><a href="<?php echo urlclinic('cart', 'index');?>">My booking chart</a></div>
        <div <?php if($output['menu_sign'] == 'myappointment'){ echo "class='active'";}else{ echo "class='normal'";}?>><em class="i2"></em><a href="index.php?act=member_appointment"><?php echo $lang['nc_member_myappointment'];?></a></div>
        <!-- <dl class="collapsed">
          ...
          <dd <?php if($output['menu_sign'] == 'collect_clic'){ echo "class='active'";}else{ echo "class='normal'";}?>><a href="index.php?act=member_favorites&op=fslist"><?php echo $lang['nc_member_path_collect_clic'];?></a></dd>
        </dl> -->
        <?php if (C('points_isuse') == 1){ ?>
        <dl class="collapsed">
          ...
          <dd <?php if($output['menu_sign'] == 'pointappointment'){ echo "class='active'";}else{ echo "class='normal'";}?>><a href="index.php?act=member_pointappointment"><?php echo $lang['nc_member_path_pointappointment'];?></a></dd>
