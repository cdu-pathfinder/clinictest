...
<link href="<?php echo clinic_TEMPLATES_URL;?>/css/home_cart.css" rel="stylesheet" type="text/css">
...
<![endif]-->
<script>
var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo clinic_SITE_URL;?>';var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var clinic_TEMPLATES_URL = '<?php echo clinic_TEMPLATES_URL;?>';var PRICE_FORMAT = '<?php echo $lang['currency'];?>%s';
</script>
...
<script src="<?php echo RESOURCE_SITE_URL;?>/js/doctors_cart.js"></script>
...
<?php require_once template('layout/layout_top');?>  <header class="ncc-head-layout">
    <div class="site-logo"><a href="<?php echo clinic_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$GLOBALS['setting_config']['site_logo']; ?>" class="pngFix"></a></div>
    <ul class="ncc-flow">
      <li class="<?php echo $output['buy_step'] == 'step1' ? 'current' : '';?>"><i class="step1"></i>
        <p><?php echo $lang['cart_index_ensure_appointment'];?></p>
        <sub></sub>
        <div class="hr"></div>
      </li>
