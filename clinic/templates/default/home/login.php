...
#footer {
	bappointment-top: none!important;
	padding-top: 30px;
}
</style>
<div class="nc-login-layout">
  <div class="left-pic"><img src="<?php echo $output['lpic'];?>"  bappointment="0"></div>
  <div class="nc-login">
      ...
      <form id="login_form" method="post" class="bg">
        ...
        <dl>
          ...
          <dd style="min-height:54px;">
            ...
            <img src="<?php echo clinic_SITE_URL?>/index.php?act=seccode&op=makecode&nchash=<?php echo getNchash();?>" name="codeimage" bappointment="0" id="codeimage" class="fl ml5"> <a href="javascript:void(0)" class="ml5" onclick="javascript:document.getElementById('codeimage').src='<?php echo clinic_SITE_URL?>/index.php?act=seccode&op=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_index_change_checkcode'];?></a>
            <label></label>
          </dd>
        </dl>
        <?php } ?>
...
$(document).ready(function(){
    $('input[name="Submit"]').click(function(){
        if($("#login_form").valid()){
        	...
        	document.getElementById('codeimage').src='<?php echo clinic_SITE_URL?>/index.php?act=seccode&op=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();
        }
    });
	$("#login_form").validate({
		...
		rules: {
            ...
            ,captcha : {
                ...
                minlength: 4,
                remote   : {
                    url : '<?php echo clinic_SITE_URL?>/index.php?act=seccode&op=check&nchash=<?php echo getNchash();?>',
                    type: 'get',
                    data:{
                        captcha : function(){
                            return $('#captcha').val();
