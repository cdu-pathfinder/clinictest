...
<div class="nc-login-layout">
  <div class="nc-login">
    ...
    <div class="nc-login-content">
      <form id="register_form" method="post" action="<?php echo clinic_SITE_URL;?>/index.php?act=login&op=usersave">
      <?php Security::getToken();?>
        ...
        <dl>
          ...
          <dd>
            ...
            <span for="clause" class="ml5"><?php echo $lang['login_register_agreed'];?><a href="<?php echo urlclinic('document', 'index',array('code'=>'agreement'));?>" target="_blank" class="agreement" title="<?php echo $lang['login_register_agreed'];?>"><?php echo $lang['login_register_agreement'];?></a></span>
            <label></label>
          </dd>
        </dl>
  ...
  <div class="nc-login-left">
    ...
    <ol>
      ...
      <li class="ico01"><i></i><?php echo $lang['login_register_openclic_info'];?></li>
