...
<link href="<?php echo clinic_TEMPLATES_URL;?>/css/index.css" rel="stylesheet" type="text/css">
<!--[if IE 6]>
  ...
  <div class="right-sidebar">
      ...
      <ul>
        ...
        <li>
          <dl style=" background-image:url(<?php echo gthumb($val['groupbuy_image1'], 'small');?>)">
            ...
            <dd class="price"><span class="groupbuy-price"><?php echo ncPriceFormatForList($val['groupbuy_price']); ?></span><span class="buy-button"><a href="<?php echo urlclinic('show_groupbuy','groupbuy_detail',array('group_id'=> $val['groupbuy_id']));?>">立即团</a></span></dd>
    ...
    <div class="proclamation">
      ...
      <!-- <div class="tabs-panel tabs-hide">
        <ul class="mall-news">
          ...
          <?php foreach($output['show_article']['notice']['list'] as $val) { ?>
            <li><i></i><a target="_blank" href="<?php echo empty($val['article_url']) ? urlclinic('article', 'show',array('article_id'=> $val['article_id'])):$val['article_url'] ;?>" title="<?php echo $val['article_title']; ?>"><?php echo str_cut($val['article_title'],24);?> </a>
      ...
      <div class="tabs-panel">
        <a href="<?php echo urlclinic('clic_joinin', 'index');?>" title="Apply for clinic admission; The application has been submitted, you can check the current audit status" class="clic-join-btn" target="_blank">&nbsp;</a>
        <a href="<?php echo urlclinic('document', 'index', array('code' => 'open_clic'));?>" target="_blank" class="clic-join-help"><i class="icon-question-sign"></i>View clinic opening agreement</a>
  ...
  <div class="right-sidebar">
    ...
    <div id="saleDiscount" class="sale-discount">
      <ul>
        ...
        <li>
          <dl>
            <dt class="doctors-name"><?php echo $val['doctors_name']; ?></dt>
            <dd class="doctors-thumb"><a href="<?php echo urlclinic('doctors','index',array('doctors_id'=> $val['doctors_id']));?>">
                <img src="<?php echo thumb($val, 240);?>"></a></dd>
            <dd class="doctors-price"><?php echo ncPriceFormatForList($val['xianshi_price']); ?>
                <span class="original"><?php echo ncPriceFormatForList($val['doctors_price']);?></span></dd>
            <dd class="doctors-price-discount"><em><?php echo $val['xianshi_discount']; ?></em></dd>
...
<script type="text/javascript" src="<?php echo clinic_RESOURCE_SITE_URL;?>/js/home_index.js" charset="utf-8"></script>
