...
<div class="ncc-bottom"> <a href="javascript:void(0)" id='submitappointment' class="ncc-btn ncc-btn-acidblue fr"><?php echo $lang['cart_index_submit_appointment'];?></a> </div>
<script>
function submitNext(){
    if ($('#address_id').val() == ''){
...
$(function(){
	$('#submitappointment').on('click',function(){submitNext()});
	calcappointment();
});
</script>