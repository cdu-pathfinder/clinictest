...
<div class="comment-widget">
  <div class="comment-edit">
    <form id="commentform_<?php echo $output['stid'];?>" method="post" action="index.php?act=clic_snshome&op=addcomment">
  ...
  <div class="more"><a target="_blank" href="index.php?act=clic_snshome&op=straceinfo&st_id=<?php echo $output['stid'];?>"><?php echo $lang['sns_comment_more'];?></a></div>
