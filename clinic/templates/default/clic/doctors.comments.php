...
<div class="tr pr5 pb5 pr">
  <a href="<?php echo urlclinic('doctors', 'comments_list', array('doctors_id' => $_GET['doctors_id']));?>" target="_blank" class="more-commend">查看全部评价>></a><div class="pagination"> <?php echo $output['show_page'];?></div>
</div>
<?php }else{?>
...
$(document).ready(function(){
   ...
   $('a[nctype="nyroModal"]').nyroModal();
    ...
    $('#doctorseval').find('.demo').ajaxContent({
