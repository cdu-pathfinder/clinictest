...
<div class="wrap">
  ...
  <form id="list_form" method="get">
    <table class="search-form">
      <input type="hidden" id='act' name='act' value='clic_voucher' />
  ...
  <table class="ncu-table-style">
    <thead>
      <tr>
        <th class="w10"></th>
        <th class="w150 tl"><?php echo $lang['inform_doctors_name'];?></th>
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td></td>
        <td class="tl"><a href="<?php echo urlclinic('doctors', 'index', array('doctors_id'=>$val['inform_doctors_id']));?>" target="_blank"> <?php echo $val['inform_doctors_name']; ?> </a></td>
        ...
        <td><?php 
                        if(empty($val['inform_pic1'])&&empty($val['inform_pic2'])&&empty($val['inform_pic3'])) {
                            ...
                            $pic_link = clinic_SITE_URL.'/index.php?act=show_pics&type=inform&pics=';
      ...
      <tr class="inform_detail">
        <td colspan="20"><div class="shadow">
            ...
            <dl style="bappointment-bottom:0;">
