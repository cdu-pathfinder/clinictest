<div class="eject_con">
  <div id="warning"></div>
  <dl>
    <dt><?php echo $lang['return_appointment_returnsn'].$lang['nc_colon'];?></dt>
    <dd><?php echo $output['return']['refund_sn']; ?></dd>
  </dl>
  <dl>
    <dt><?php echo $lang['return_appointment_add_time'].$lang['nc_colon'];?></dt>
    <dd class="doctors-time"><?php echo date("Y-m-d H:i:s",$output['return']['add_time']);?> </dd>
  </dl>
  <dl>
