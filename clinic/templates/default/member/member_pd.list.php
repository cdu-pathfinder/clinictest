...
<div class="wrap">
  ...
  <table class="ncu-table-style">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td class="doctors-num"><?php echo $val['pdr_sn'];?></td>
        <td class="doctors-time"><?php echo date('Y-m-d H:i:s',$val['pdr_add_time']);?></td>
        <td><?php echo $val['pdr_payment_name'];?></td>
        <td class="doctors-price"><?php echo $val['pdr_amount'];?></td>
