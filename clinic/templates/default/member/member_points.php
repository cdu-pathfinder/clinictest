...
<div class="wrap">
    ...
    <table class="search-form">
      ...
      <tr><td></td>
        ...
        <td class="w100"><select name="stage">
            ...
            <option value="appointment" <?php if ($_GET['stage'] == 'appointment'){echo 'selected=selected';}?>><?php echo $lang['points_stage_appointment']; ?></option>
            <option value="system" <?php if ($_GET['stage'] == 'system'){echo 'selected=selected';}?>><?php echo $lang['points_stage_system']; ?></option>
            <option value="pointappointment" <?php if ($_GET['stage'] == 'pointappointment'){echo 'selected=selected';}?>><?php echo $lang['points_stage_pointappointment']; ?></option>
  ...
  <table class="ncu-table-style">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td class="doctors-time"><?php echo @date('Y-m-d',$val['pl_addtime']);?></td>
        <td class="doctors-price"><?php echo ($val['pl_points'] > 0 ? '+' : '').$val['pl_points']; ?></td>
        <td><?php 
	              	switch ($val['pl_stage']){
	              		case 'regist':
	              		...
	              		case 'comments':
	              			...
	              			break;
	              		case 'appointment':
	              			echo $lang['points_stage_appointment'];
	              			break;
	              		case 'system':
	              			echo $lang['points_stage_system'];
	              			break;
	              		case 'pointappointment':
	              			echo $lang['points_stage_pointappointment'];
	              			break;
	              		case 'app':
