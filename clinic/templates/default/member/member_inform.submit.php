...
<div class="wrap">
  ...
  <div class="ncu-form-style">
    ...
    <form id="add_form" enctype="multipart/form-data" method="post" action="index.php?act=member_inform&op=inform_save">
      <input name="inform_doctors_id" type="hidden" value=<?php echo $output['doctors_info']['doctors_id']; ?> />
      <dl>
        <dt><?php echo $lang['inform_doctors_name'].$lang['nc_colon'];?></dt>
        <dd> <a href="<?php echo urlclinic('doctors', 'index',array('doctors_id'=>$output['doctors_info']['doctors_id']));?>" target="_blank"> <?php echo $output['doctors_info']['doctors_name']; ?> </a> </dd>
      </dl>
      <dl>
