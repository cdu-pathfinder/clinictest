...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(".input-file").fileupload({
            dataType: 'json',
            url: "<?php echo urlclinic('sns_album', 'swfupload');?>",
            formData: "",
            add: function(e, data) {
        ...
        function album_pic_del(file_id) {
            var del_url = "<?php echo urlclinic('sns_album', 'album_pic_del');?>";
            del_url += '&id=' + file_id;
            $.get(del_url);
        }
...
<form id="add_form" action="<?php echo urlclinic('member_evaluate', 'add_image_save');?>" method="post">
  ...
  <div class="wrap-shadow">
    <div class="wrap-all ncu-appointment-view">
      ...
      <table class="ncu-table-style">
        ...
        <tbody>
          <tr>
            <td><div class="doctors-pic-small">
<span class="thumb size60">
<i></i>
<a target="_blank" href="<?php echo urlclinic('doctors', 'index', array('doctors_id' => $output['geval_info']['geval_doctorsid']));?>">
<img src="<?php echo cthumb($output['doctors_info']['doctors_image'], 60);?>">
</a>
</span>
</div></td>
            <td class="tl"><a href="<?php echo urlclinic('doctors', 'index', array('doctors_id' => $output['geval_info']['geval_doctorsid']));?>" target="_blank" class="ml20"><?php echo $output['geval_info']['geval_doctorsname'];?></a></td>
      ...
      <div class="tc mt20 mb20"> <a id="btn_submit" href="javascript:;" class="ncu-btn5">确定提交</a> <a href="<?php echo urlclinic('member_evaluate', 'list');?>" class="ml30">取消返回</a> </div>
    </div>
  </div>
</form>
