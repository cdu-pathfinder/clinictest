...
<div class="feededitor">
  <form method="post" action="index.php?act=member_snsindex&op=sharedoctors" id="sharedoctors_form">
    <input type="hidden" name="form_submit" value="ok"/>
    <input type="hidden" id="choosedoctorsid" name="choosedoctorsid" value="<?php echo intval($output['doctors_info']['doctors_id']);?>" />
    
    <!-- 商品图片end -->
    <div class="doctors">
      <div class="pic"><span class="thumb size90"><i></i> <a target="_blank" href="<?php echo urlclinic('doctors','index',array('doctors_id'=>$output['doctors_info']['doctors_id']));?>"> <img title="<?php echo $output['doctors_info']['doctors_name']; ?>" src="<?php echo thumb($output['doctors_info'],60);?>" /> </a></span></div>
      <dl class="intro">
        <dt><a target="_blank" href="<?php echo urlclinic('doctors','index',array('doctors_id'=>$output['doctors_info']['doctors_id']));?>"><?php echo $output['doctors_info']['doctors_name']; ?></a></dt>
        <dd><?php echo $lang['sns_sharedoctors_price'].$lang['nc_colon']; ?><span class="doctors-price"><strong><?php echo $output['doctors_info']['doctors_price']; ?></strong></span></dd>
        <dd><?php echo $lang['sns_sharedoctors_freight'].$lang['nc_colon']; ?><span class="doctors-price"><i><?php echo $output['doctors_info']['doctors_freight'];?></i></span></dd>
      </dl>
    </div>
    <!-- 站外分享 -->
    ...
    <?php }?>
    <div class="p10">
      <textarea placeholder="<?php echo $lang['sns_sharedoctors_contenttip2'];?>" name="comment" id="content_sgweibo" resize="none"></textarea>
      ...
      <div class="handle">
        ...
        <input name="<?php echo $lang['nc_snsshare'];?>" type="button" class="button" value="<?php echo $lang['nc_snsshare'];?>" id="weibobtn_doctors" />
