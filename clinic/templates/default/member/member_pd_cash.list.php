...
<div class="wrap">
  ...
  <table class="ncu-table-style">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td class="doctors-num"><?php echo $val['pdc_sn'];?></td>
        <td class="doctors-time"><?php echo @date('Y-m-d H:i:s',$val['pdc_add_time']);?></td>
        <td class="doctors-price"><?php echo $val['pdc_amount'];?></td>
