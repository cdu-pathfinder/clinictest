<div class="eject_con">
  <div id="warning"></div>
  <dl>
    <dt><?php echo $lang['member_appointment_clic_name'].$lang['nc_colon'];?></dt>
    <dd><?php echo $output['refund']['clic_name']; ?></dd>
  </dl>
  <dl>
  ...
  <dl>
    ...
    <dd class="doctors-time"><?php echo date("Y-m-d H:i:s",$output['refund']['add_time']);?></dd>
  </dl>
  <dl>
