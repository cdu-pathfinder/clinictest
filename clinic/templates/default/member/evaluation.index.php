...
<form id="doctorsevalform" method="get">
  ...
  <table class="ncu-table-style appointment">
    ...
    <tbody>
        ...
        <?php foreach ((array)$output['doctorsevallist'] as $k=>$v){?><tr>
<td class="sep-row" colspan="19"></td>
</tr>
<tr>
    <th colspan="20">
        <span class="ml10"><?php echo $lang['member_evaluation_doctorsinfo_title'];?>
            <a target="_blank" href="<?php echo urlclinic('doctors', 'index', array('doctors_id'=>$v['geval_doctorsid'])); ?>"><?php echo $v['geval_doctorsname']?></a>
        </span>
        <div class="raty" style="display:inline-block;" data-score="<?php echo $v['geval_scores'];?>"></div>
        <?php if(empty($v['geval_image'])) {?>
        <a href="<?php echo urlclinic('member_evaluate', 'add_image', array('geval_id' => $v['geval_id']));?>">晒单</a>
        <?php } ?>
    </th>
</tr>
<tr>
