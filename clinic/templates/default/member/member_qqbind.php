...
<div class="tabmenu"><?php include template('layout/submenu');?></div>
  <div class="bind">
    ...
    <?php } else {?>
      <div class="left">
        <p class="ico"><a href="<?php echo clinic_SITE_URL;?>/api.php?act=toqq"><img src="<?php echo clinic_TEMPLATES_URL;?>/images/qq_bind_small.gif"></a></a>
        <p class="hint"><?php echo $lang['member_qqconnect_binding_click']; ?></p>
      </div>
      <div class="right">
        <dl>
          <dt class="qq"><?php echo $lang['member_qqconnect_binding_doctortip_1']; ?></dt>
          <dd>
            <p><?php echo $lang['member_qqconnect_binding_doctortip_2']; ?></p>
            <p class="hint"><?php echo $lang['member_qqconnect_binding_doctortip_3']; ?></p>
          </dd>
        </dl>
      </div>
    <div class="clear"></div>
