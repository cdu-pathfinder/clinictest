...
<div class="ncsc-form-default">
  <form method="post" action="<?php if (empty($output['plate_info'])) { echo urlclinic('clic_plate', 'plate_add');} else { echo urlclinic('clic_plate', 'plate_edit');}?>" id="plate_form">
    ...
    <input type="hidden" name="p_id" value="<?php echo $output['plate_info']['plate_id'];?>"/>
        ...
        <dl>
          ...
          <dd>
            ...
            <p class="hr8">
              <a class="ncsc-btn" nctype="show_desc" href="index.php?act=clic_album&op=pic_list&item=des"><i class="icon-picture"></i>插入相册图片</a>
