...
$(function () {
    ...
    $(document).ready(function() {
    	chart = new Highcharts.Chart({
          ...
          allowDecimals: false,
    			title: {
    				text: '<?php echo $lang['stat_doctors_sale_tip']; ?>',
    				align: 'high'
    			},
    			labels: {
    				overflow: 'justify'
  ...
  <form method="get" action="index.php">
    <table class="search-form">
      ...
      <input type="hidden" name="op" value="doctors_sale_statistics" />
      <tr>
...
<script type="text/javascript">
	$(function(){
	    ...
	    $('#week_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics_sale&op=doctors_sale_statistics';
		})
		$('#month_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics_sale&op=doctors_sale_statistics&type=month';
		})
		$('#year_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics_sale&op=doctors_sale_statistics&type=year';
		})
	});
</script>
