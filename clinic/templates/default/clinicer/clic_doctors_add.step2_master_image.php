<div class="doctors-gallery add-step2"><a class='sample_demo' id="select_submit" href="index.php?act=clic_album&op=pic_list&item=doctors" style="display:none;"><?php echo $lang['nc_submit'];?></a>
