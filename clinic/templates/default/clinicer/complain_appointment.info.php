...
<dl>
  <dt><?php echo $lang['appointment_buyer_name'].$lang['nc_colon'];?></dt>
  ...
  <dd>
    <a href="<?php echo clinic_SITE_URL;?>/index.php?act=clic_appointment&op=show_appointment&appointment_id=<?php echo $output['appointment_info']['appointment_id'];?>" target="_blank"> <?php echo $output['appointment_info']['appointment_sn'];?> </a>
  </dd>
