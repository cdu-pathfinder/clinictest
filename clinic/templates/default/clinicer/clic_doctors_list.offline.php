...
<table class="ncsc-table-style">
  <thead>
    <tr nc_type="table_header">
      ...
      <th class="w180"><?php echo $lang['clic_doctors_index_show'];?></th>
    ...
    <tr>
      ...
      <td colspan="10"><label for="all"><?php echo $lang['nc_select_all'];?></label>
        <a href="javascript:void(0);" class="ncsc-btn-mini" nc_type="batchbutton" uri="<?php echo urlclinic('clic_doctors_online', 'drop_doctors');?>" name="commonid" confirm="<?php echo $lang['nc_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['nc_del'];?></a> <a href="javascript:void(0);" class="ncsc-btn-mini" nc_type="batchbutton" uri="<?php echo urlclinic('clic_doctors_offline', 'doctors_show');?>" name="commonid"><i class="icon-level-up"></i><?php echo $lang['clic_doctors_index_show'];?></a>
    </tr>
    <?php } ?>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td><a href="javascript:void(0)" onclick="ajax_get_confirm('','<?php echo urlclinic('clic_doctors_offline', 'doctors_show', array('commonid' => $val['doctors_commonid']));?>')" class="ncsc-btn"><?php echo $lang['clic_doctors_index_show'];?></a></td>
