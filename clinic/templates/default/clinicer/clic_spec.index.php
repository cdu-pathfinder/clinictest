...
<div nctype="class_spec" class="ncsc-doctors-spec">
...
function editSpecValue(o) {
    ...
    $_iframe = $('<iframe id="iframepage" name="iframepage" frameBappointment=0 scrolling=no width="100%" height="630px" src="<?php echo clinic_SITE_URL;?>/index.php?act=clic_spec&op=add_spec&spid=' + data_str.spid + '&gcid=' + data_str.gcid + '" ></iframe>');
