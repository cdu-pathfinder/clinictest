...
<div class="ncsc-form-default">
  <form method="post" action="index.php?act=clic_navigation&op=navigation_save" target="_parent" name="clic_navigation_form" id="clic_navigation_form" enctype="multipart/form-data">
    <input type="hidden" name="sn_id" value="<?php echo $output['sn_info']['sn_id'];?>"/>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['clic_navigation_name'].$lang['nc_colon'];?></dt>
      <dd>
        <input type="text" class="w150 text" name="sn_title" value="<?php echo $output['sn_info']['sn_title'];?>" /><span></span>
      </dd>
    </dl>
    <dl>
      <dt><?php echo $lang['clic_navigation_display'].$lang['nc_colon'];?></dt>
      <dd>
        <ul class="ncsc-form-radio-list">
          <li>
            ...
            <?php echo $lang['clic_payment_yes'];?></label></li>
          <li>
            ...
            <?php echo $lang['clic_payment_no'];?></label></li>
        </ul>
      </dd>
    </dl>
    <dl>
      <dt><?php echo $lang['clic_doctors_class_sort'].$lang['nc_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><?php echo $lang['clic_navigation_content'].$lang['nc_colon'];?></dt>
      <dd>
        <?php showEditor('sn_content',$output['sn_info']['sn_content'],'600px','300px','','false',$output['editor_multimedia']); ?>
      </dd>
    </dl>
    <dl>
      <dt><?php echo $lang['clic_navigation_url'].$lang['nc_colon']; ?></dt>
      <dd>
        <p>
          <input type="text" class="w300 text" name="sn_url" value="<?php echo $output['sn_info']['sn_url'];?>" />
        </p>
        <p class="hint"><?php echo $lang['clic_navigation_url_tip']; ?></p>
        </td>
    </dl>
    <dl>
      <dt><?php echo $lang['clic_navigation_new_open'].$lang['nc_colon']; ?></dt>
      <dd>
        <ul class="ncsc-form-radio-list">
          <li>
            ...
            <?php echo $lang['clic_navigation_new_open_yes']; ?></label></li>
          <li>
            ...
            <?php echo $lang['clic_navigation_new_open_no']; ?></label></li>
        </ul>
      </dd>
    </dl>
    <div class="bottom">
...
$(document).ready(function(){
	...
	$('#clic_navigation_form').validate({
        ...
        messages: {
            sn_title: {
                required: '<i class="icon-exclamation-sign"></i><?php echo $lang['clic_navigation_name_null'];?>',
                maxlength: '<i class="icon-exclamation-sign"></i><?php echo $lang['clic_navigation_name_max'];?>'
            }
        }
    });
});
