  ...
  <dd>
    <?php
                        if(empty($output['complain_info']['complain_pic1'])&&empty($output['complain_info']['complain_pic2'])&&empty($output['complain_info']['complain_pic3'])) {
                            ...
                            $pic_link = clinic_SITE_URL.'/index.php?act=show_pics&type=complain&pics=';
...
<h4><?php echo $lang['complain_doctors'];?></h4>
<table class="appointment ncsc-table-style">
  <thead>
    <tr>
      <th class="w10"></th>
      <th class="w70"></th>
      <th class="tl"><?php echo $lang['complain_doctors_name'];?></th>
  ...
  <tbody>
    ...
    <tr>
      <th colspan="20"><span class="ml10"><?php echo $lang['complain_text_problem'].$lang['nc_colon'];?><?php echo $complain_doctors['complain_message'];?></span></th>
    </tr>
    <tr>
      <td class="bdl"></td>
      <td><div class="doctors-pic-small"><span class="thumb size60"><i></i><a href="<?php echo urlclinic('doctors', 'index', array('doctors_id'=>$complain_doctors['doctors_id']));?>" target="_blank"> <img onload="javascript:DrawImage(this,60,60);" src="<?php echo cthumb($complain_doctors['doctors_image'], 60,$output['appointment_info']['clic_id']);?>"/> </a></span></div></td>
      <td>
        <a href="<?php echo urlclinic('doctors', 'index', array('doctors_id'=>$complain_doctors['doctors_id']));?>" target="_blank"> <?php echo $complain_doctors['doctors_name'];?> </a>
        </td>
      <td class="bdl"><?php echo $complain_doctors['doctors_num'];?></td>
      <td class="bdl bdr"><em class="doctors-price"><?php echo $complain_doctors['doctors_price'];?></em></td>
    </tr>
    <?php } ?>
  </tbody>
  <tfoot>
