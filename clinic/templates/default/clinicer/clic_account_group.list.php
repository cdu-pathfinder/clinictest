...
<div class="tabmenu">
  ...
  <a href="javascript:void(0)" class="ncsc-btn ncsc-btn-green" onclick="go('index.php?act=clic_account_group&op=group_add');" title="添加帐号">group add</a> </div>
<table class="ncsc-table-style">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="<?php echo urlclinic('clic_account_group', 'group_edit', array('group_id' => $value['group_id']));?>" class="btn-blue"><i class="icon-edit"></i>
...
<form id="del_form" method="post" action="<?php echo urlclinic('clic_account_group', 'group_del');?>">
