<div class="eject_con">
  ...
  <form action="index.php?act=clic_return&op=receive&return_id=<?php echo $output['return']['refund_id']; ?>" method="post" id="post_form">
    ...
    <div class="bottom">
        <label class="submit-bappointment"><input type="submit" class="submit" id="confirm_yes" value="<?php echo $lang['nc_ok'];?>" /></label>
    </div>
  </form>
</div>
