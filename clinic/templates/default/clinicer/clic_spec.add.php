...
<link href="<?php echo clinic_RESOURCE_SITE_URL;?>/font/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
<!--[if IE 7]>
  <link href="<?php echo clinic_RESOURCE_SITE_URL;?>/font/font-awesome/css/font-awesome-ie7.min.css" rel="stylesheet" type="text/css">
<![endif]-->
<style type="text/css">
body {
...
.evo-colorind, .evo-colorind-ie, .evo-colorind-ff {
	width: 21px;
	height: 28px;
	bappointment: solid #CCC;
	bappointment-width: 1px 1px 1px 0;
	float: right;
}
.iframe-box {
	width: 100%;
...
<form id="spec_form" method="post" action="<?php echo clinic_SITE_URL;?>/index.php?act=clic_spec&op=save_spec">
...
$(function(){
    ...
    $('a[nctype="submit-btn"]').click(function(){
        ...
        if (_submit) {
            ajaxpost('spec_form', '<?php echo clinic_SITE_URL;?>/index.php?act=clic_spec&op=save_spec', '', 'onerror');
        }
    });
    ...
    $('a[nctype="spec_del"]').click(function(){
        ...
        $.getJSON('index.php?act=clic_spec&op=ajax_delspec&id='+data_str.id, function(data){
            if(data){
                $this.parents('tr:first').remove();
            }
        });
