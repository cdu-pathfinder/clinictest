...
<div class="ncsc-form-default">
  <form id="add_form" action="<?php echo urlclinic('clic_groupbuy', 'groupbuy_quota_add_save');?>" method="post">
    <dl>
    ...
    <div class="bottom">
      <label class="submit-bappointment"><input id="submit_button" type="submit" class="submit" value="<?php echo $lang['nc_submit'];?>"></label>
    </div>
  </form>
</div>
