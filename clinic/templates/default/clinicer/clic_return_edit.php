<div class="eject_con">
  ...
  <form id="post_form" method="post" action="index.php?act=clic_return&op=edit&return_id=<?php echo $output['return']['refund_id']; ?>">
    <input type="hidden" name="form_submit" value="ok" />
  <dl>
    <dt><?php echo '商品名称'.$lang['nc_colon'];?></dt>
    <dd><?php echo $output['return']['doctors_name']; ?></dd>
  </dl>
  <dl>
    <dt><?php echo $lang['refund_appointment_refund'].$lang['nc_colon'];?></dt>
    <dd><?php echo $lang['currency'];?><?php echo $output['return']['refund_amount']; ?></dd>
  </dl>
  <dl>
    <dt><?php echo $lang['return_appointment_return'].$lang['nc_colon'];?></dt>
    <dd><?php echo $output['return']['return_type']==2 ? $output['return']['doctors_num']:'无'; ?></dd>
  </dl>
  <dl>
    ...
    <div class="bottom">
      <label class="submit-bappointment"><input type="submit" class="submit" id="confirm_button" name="confirm_button" value="<?php echo $lang['nc_ok'];?>" /></label>
    </div>
  </form>
</div>
