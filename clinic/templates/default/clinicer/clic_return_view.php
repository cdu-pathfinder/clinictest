<div class="eject_con">
  <div id="warning"></div>
  <dl>
    <dt><?php echo $lang['refund_appointment_buyer'].$lang['nc_colon'];?></dt>
...
$(function(){
	$.getJSON('index.php?act=clic_deliver&op=get_express&e_code=<?php echo $output['e_code'];?>&shipping_code=<?php echo $output['return']['invoice_no'];?>&t=<?php echo random(7);?>',function(data){
		if(data){
