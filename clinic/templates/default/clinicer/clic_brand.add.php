<div class="eject_con">
  ...
  <form method="post" target="_parent" action="index.php?act=clic_brand&op=<?php if ($output['brand_array']['brand_id']!='') echo 'brand_edit'; else echo 'brand_save'; ?>"enctype="multipart/form-data" id="brand_apply_form">
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="brand_id" value="<?php echo $output['brand_array']['brand_id']; ?>" />
    <dl>
      <dt><i class="required">*</i><?php echo $lang['clic_doctors_brand_name'].$lang['nc_colon'];?></dt>
      <dd>
        <input type="text" class="text" name="brand_name" value="<?php echo $output['brand_array']['brand_name']; ?>" id="brand_name" />
      </dd>
    </dl>
    <dl>
      <dt><?php echo $lang['clic_doctors_brand_class'].$lang['nc_colon'];?></dt>
      <dd id="gcategory">
    ...
    <dl>
      <dt><i class="required">*</i><?php echo $lang['clic_doctors_brand_icon'].$lang['nc_colon'];?></dt>
      <dd>
        ...
        <p class="hint"><?php echo $lang['clic_doctors_brand_upload_tip'];?></p>
      </dd>
    </dl>
    <div class="bottom">
      <label class="submit-bappointment"><input type="submit" class="submit" value="<?php echo $lang['nc_submit'];?>"/></label>
    </div>
  </form>
</div>
<script>
$(function(){
    ...
    $('#brand_apply_form').validate({
        ...
        messages : {
            brand_name : {
                required : '<i class="icon-exclamation-sign"></i><?php echo $lang['clic_doctors_brand_input_name'];?>',
                rangelength: '<i class="icon-exclamation-sign"></i><?php echo $lang['clic_doctors_brand_name_error'];?>'
            }
			<?php if ($output['brand_array']['brand_id']=='') { ?>
			,
            brand_pic : {
                required : '<i class="icon-exclamation-sign"></i><?php echo $lang['clic_doctors_brand_icon_null'];?>'
			}
			<?php } ?>
        }
    });
