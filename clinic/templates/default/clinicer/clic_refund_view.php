<div class="eject_con">
  <div id="warning"></div>
  <dl>
    <dt><?php echo $lang['refund_appointment_refundsn'].$lang['nc_colon'];?></dt>
    <dd><?php echo $output['refund']['refund_sn'];?></dd>
  </dl>
  <dl>
    <dt><?php echo $lang['refund_appointment_add_time'].$lang['nc_colon'];?></dt>
  ...
  <dl>
    ...
    <dd> <?php echo $output['refund']['doctors_name']; ?> </dd>
  </dl>
  <dl>
    <dt><?php echo $lang['refund_appointment_refund'].$lang['nc_colon'];?></dt>
    <dd class="doctors-price"><?php echo $lang['currency'];?><?php echo $output['refund']['refund_amount']; ?></dd>
  </dl>
  <dl>
