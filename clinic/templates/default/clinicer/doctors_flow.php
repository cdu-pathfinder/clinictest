...
$(function () {
    ...
    $(document).ready(function() {
    	chart = new Highcharts.Chart({
    		...
    		xAxis: {
    			categories: [<?php echo $output['result_doctors_str']; ?>],
    			title: {
    				text: null
    			},
    			labels: {
          ...
          allowDecimals: false,
    			title: {
    				text: '<?php echo $lang['stat_doctors_flow_tip']; ?>',
    				align: 'high'
    			},
    			labels: {
    				overflow: 'justify'
  ...
  <form method="get" action="index.php">
    <table class="search-form">
      ...
      <input type="hidden" name="op" value="doctors_flow_statistics" />
      <tr>
...
<script type="text/javascript">
	$(function(){
	    ...
	    $('#week_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics_flow&op=doctors_flow_statistics';
		})
		$('#month_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics_flow&op=doctors_flow_statistics&type=month';
		})
		$('#year_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics_flow&op=doctors_flow_statistics&type=year';
		})
	});
</script>
