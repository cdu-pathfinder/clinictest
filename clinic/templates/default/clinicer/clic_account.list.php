...
<div class="tabmenu">
  ...
  <a href="javascript:void(0)" class="ncsc-btn ncsc-btn-green" onclick="go('index.php?act=clic_account&op=account_add');" title="添加帐号">add account</a> </div>
  ...
  <tbody>
    ...
    <td></td>
      ...
      <td class="nscs-table-handle">
          <span><a href="<?php echo urlclinic('clic_account', 'account_edit', array('seller_id' => $value['seller_id']));?>" class="btn-blue"><i class="icon-edit"></i>
...
<form id="del_form" method="post" action="<?php echo urlclinic('clic_account', 'account_del');?>">
