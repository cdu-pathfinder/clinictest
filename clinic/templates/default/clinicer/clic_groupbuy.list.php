...
<div class="tabmenu">
  ...
  <a href="<?php echo urlclinic('clic_groupbuy', 'groupbuy_add');?>" style="right:100px" class="ncsc-btn ncsc-btn-green" title="<?php echo $lang['groupbuy_index_new_group'];?>"><i class="icon-plus-sign"></i><?php echo $lang['groupbuy_index_new_group'];?></a> <a class="ncsc-btn ncsc-btn-acidblue" href="<?php echo urlclinic('clic_groupbuy', 'groupbuy_quota_add');?>" title="套餐续费"><i class="icon-money"></i>套餐续费</a>
  <?php } else { ?>
  <a class="ncsc-btn ncsc-btn-acidblue" href="<?php echo urlclinic('clic_groupbuy', 'groupbuy_quota_add');?>" title="购买套餐"><i class="icon-money"></i>购买套餐</a>
  <?php } ?>
</div>
...
<table class="search-form">
  <form method="get">
    <input type="hidden" name="act" value="clic_groupbuy" />
    <tr>
      <td>&nbsp;</td>
