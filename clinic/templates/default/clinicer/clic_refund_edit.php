<div class="eject_con">
  ...
  <form id="post_form" method="post" action="index.php?act=clic_refund&op=edit&refund_id=<?php echo $output['refund']['refund_id']; ?>">
    ...
    <div class="bottom">
      <label class="submit-bappointment"><input type="submit" class="submit" id="confirm_button" value="<?php echo $lang['nc_ok'];?>" /></label>
    </div>
  </form>
</div>
