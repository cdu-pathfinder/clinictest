...
<div class="tabmenu">
  ...
  <a href="<?php echo urlclinic('clic_plate', 'plate_add');?>" class="ncsc-btn ncsc-btn-green" title="添加关联版式">添加关联版式</a>
</div>
...
<form method="get">
<input type="hidden" name="act" value="clic_plate">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle">
        <span><a href="<?php echo urlclinic('clic_plate', 'plate_edit', array('p_id' => $val['plate_id']));?>" class="btn-blue"><i class="icon-edit"></i><p><?php echo $lang['nc_edit'];?></p></a></span>
        <span><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['nc_ensure_del'];?>', '<?php echo urlclinic('clic_plate', 'drop_plate', array('p_id' => $val['plate_id']));?>');" class="btn-red"><i class="icon-trash"></i><p><?php echo $lang['nc_del'];?></p></a></span>
      </td>
    </tr>
    <?php } ?>
    <?php } else { ?>
