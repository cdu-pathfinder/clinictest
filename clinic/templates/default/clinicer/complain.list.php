...
<form method="get" action="index.php">
  <table class="search-form">
    <input type="hidden" name='act' value='clic_complain' />
    <tr>
      <td>&nbsp;</td>
...
<table class="ncsc-table-style">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="doctors-time"><?php echo date("Y-m-d H:i:s",$val['complain_datetime']);?></td>
      <td><?php
				...
				?></td>
      <td class="nscs-table-handle"><span><a href="index.php?act=clic_complain&op=complain_show&complain_id=<?php echo $val['complain_id'];?>" target="_blank" class="btn-blue"><i class="icon-edit"></i>
