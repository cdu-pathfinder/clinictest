...
$lang['bundling_add_doctors_explain']			= '搭配销售的商品可上下<br/>拖移商品列可自定义显<br/>示排序；编辑、删除、<br/>排序等操作提交后生效。';
$lang['bundling_doctors']						= '商品';
$lang['bundling_show_name']					= '显示名称';
$lang['bundling_cost_price']				= '原价';
$lang['bundling_cost_price_note']			= '&nbsp;(已添加搭配商品的默认价格总计)';
$lang['bundling_doctors_add']					= '添加商品';
...
$lang['bundling_add_doctors_error']			= '请选择2件及以上的商品';
...
$lang['bundling_add_doctors_show_note']		= '商品已下架，请重新上架或选择其他商品';

/**
 * 添加套餐商品
 */
$lang['bundling_doctors_clic_class']			= '店铺分类';
$lang['bundling_doctors_name']				= '商品名称';
$lang['bundling_doctors_code']				= '货号';
$lang['bundling_doctors_price']				= '价格';
$lang['bundling_doctors_storage']				= '库存';
$lang['bundling_doctors_storage_not_enough']	= '库存不足，不能添加商品。';
$lang['bundling_doctors_add_bundling']		= '添加到优惠套装';
$lang['bundling_doctors_add_bundling_exit']	= '从优惠套装移除';
$lang['bundling_doctors_add_enough_prompt']	= '您已经添加了%d个，不能在继续添加商品。';
$lang['bundling_doctors_remove']				= '移除';
 ...
 * 活动列表
 */
$lang['bundling_list_doctors_count']			= '商品数量';